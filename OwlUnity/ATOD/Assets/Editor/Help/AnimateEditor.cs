...
public class AnimateEditor : EditorWindow {
	...
	[MenuItem("Animate/windows")]
	static void ShowAnimateWindow()
	{
		AnimateEditor window= EditorWindow.GetWindow(typeof(AnimateEditor)) as AnimateEditor;
		window.Show();
	}
